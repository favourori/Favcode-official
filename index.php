        ...
        <div class="main-container">
            <section class="cover height-80 imagebg switchable --siwtchable-switch p-md-50" style="" data-overlay="8">
                <div class="background-image-holder">
                    <img alt="background" src="images/headerBg.jpg" />
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-7">
                            <div class="switchable__text">
                                <h2>
                               <span style="background-color:#428378; padding: 0 7px; border-radius:5px"> Learn how to code for free</span></h2>
                                <p class="lead">
            ...
            <section>
                <div class="container">
                <h3  style="background-color:#428378; padding: 0 7px; border-radius:5px; color:white">Available Learning Tracks</h3>
                <div class="boxed boxed--border">
	<h4 style="color:#3d9386">Wordpress For Developers <span class="closed"> Closed </span> </h4>
	<p >
    WordPress is an Open Source software system used by millions of people around the world to create beautiful websites and blogs. Start creating with wordpress.
	</p>
	<p><span class="content">Installation</span> 
...
<div class="boxed boxed--border">
	<h4 style="color:#3d9386">Frontend Development <span class="closed"> Closed</span> <span class="open"> Opens : August 13th</span></h4>
	<p>
    The beginner's guide to becoming a web developer. At the end of this class, you should be able to master the basics of the web. You will also create dynamic apps with MAVO
	</p>
	<p><span class="content">HTML</span> 
...
<div class="boxed boxed--border">
	<h4 style="color:#3d9386">Ai with IBM Watson <span class="closed"> Closed</span> </h4>
	<p>
    ...
    <p><span class="content">Development</span> 
    <span class="content">Deployment</span> 
   
    </p>
</div>

<div class="boxed boxed--border">
	<h4 style="color:#3d9386">Data Science <span class="open"> Running</span> </h4>
    

	<p>
    Data science is an interdisciplinary field that uses scientific methods, processes, algorithms and systems to extract knowledge and insights from data in various forms, both structured and unstructured, similar to data mining
	</p>
    <p><span class="content">Python</span> 
    <span class="content">Machine Learning</span> 
    <span class="content"> Deep learning </span> 
    </p>
</div>

<div class="boxed boxed--border">
	<h4 style="color:#3d9386">UI/UX <span class="open"> Running</span></h4>
	<p>
    ...
    <p><span class="content">Figma</span> 
    <span class="content">Adobe CC</span> 
    <span class="content"> Sketch</span> 
    </p>
</div>
